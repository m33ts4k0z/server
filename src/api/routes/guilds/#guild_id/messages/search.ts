...
router.get(
    ...
    async (req: Request, res: Response) => {
        ...
        const permissions = await getPermission(req.user_id, guild_id, channel_id as string | undefined);
        ...
        if (channel_id) query.where.channel = { id: channel_id };
            ...
            for (const channel of channels) {
                const perm = await getPermission(req.user_id, guild_id, channel.id);
